...
public class JanelaPrincipal {
	...
	private void initialize() {
		...
		btnProfessor.setBounds(205, 224, 111, 41);
		...
		btnAluno1.setBounds(10, 224, 111, 41);
		...
		btnCurso.setBounds(413, 224, 111, 41);
		btnCurso.setHorizontalAlignment(SwingConstants.LEFT);
		panel.add(btnCurso);
		
		JLabel lblNewLabel = new JLabel("Gerenciador Estudantil");
		lblNewLabel.setBounds(205, 72, 226, 14);
